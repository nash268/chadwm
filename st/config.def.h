 ...
 */
static char *font = "0xProto Nerd Font :pixelsize=15:antialias=true:autohint=true";
static char *font2[] = { "0xProto Nerd Font :pixelsize=15:antialias=true:autohint=true" };
